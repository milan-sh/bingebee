...
const regsiterUser = asyncHandler(async (req, res) => {
  ...
  //refining data and removing password and refreshtoken which will be send to frontend
...
const logoutUser = asyncHandler(async (req, res) => {
  await User.findByIdAndUpdate(
    //as we have used middlware and there we add founded user in req so here we can access
    req.user._id,
    {
      $unset: {
